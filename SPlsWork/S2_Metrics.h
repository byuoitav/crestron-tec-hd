...
#define __S2_Metrics_DMPSMAC_STRING_INPUT 2
#define __S2_Metrics_DMPSMAC_STRING_MAX_LEN 17
CREATE_STRING_STRUCT( S2_Metrics, __DMPSMAC, __S2_Metrics_DMPSMAC_STRING_MAX_LEN );

#define __S2_Metrics_CLIENTBUFFER_BUFFER_INPUT 3
...
#define __S2_Metrics_CLIENT_SOCKET 4
...
#define __S2_Metrics_LOCALCONSOLE_SOCKET 5
#define __S2_Metrics_LOCALCONSOLE_STRING_MAX_LEN 1024
START_SOCKET_DEFINITION( S2_Metrics, __LOCALCONSOLE )
{
   int SocketStatus;
   enum ESplusSocketType eSocketType;
   int SocketID;
   void *SocketPtr;
CREATE_SOCKET_STRING( S2_Metrics, SocketRxBuf, __S2_Metrics_LOCALCONSOLE_STRING_MAX_LEN );
};
#define __S2_Metrics_TOUCHPANELCONSOLE_SOCKET 6
#define __S2_Metrics_TOUCHPANELCONSOLE_STRING_MAX_LEN 1024
START_SOCKET_DEFINITION( S2_Metrics, __TOUCHPANELCONSOLE )
{
   int SocketStatus;
   enum ESplusSocketType eSocketType;
   int SocketID;
   void *SocketPtr;
CREATE_SOCKET_STRING( S2_Metrics, SocketRxBuf, __S2_Metrics_TOUCHPANELCONSOLE_STRING_MAX_LEN );
};
...
#define __S2_Metrics_$MAC_STRING_MAX_LEN 17
CREATE_STRING_STRUCT( S2_Metrics, __$MAC, __S2_Metrics_$MAC_STRING_MAX_LEN );
#define __S2_Metrics_$BUILDING_STRING_MAX_LEN 30
CREATE_STRING_STRUCT( S2_Metrics, __$BUILDING, __S2_Metrics_$BUILDING_STRING_MAX_LEN );
#define __S2_Metrics_$ROOM_STRING_MAX_LEN 30
CREATE_STRING_STRUCT( S2_Metrics, __$ROOM, __S2_Metrics_$ROOM_STRING_MAX_LEN );
#define __S2_Metrics_$FLOOR_STRING_MAX_LEN 4
CREATE_STRING_STRUCT( S2_Metrics, __$FLOOR, __S2_Metrics_$FLOOR_STRING_MAX_LEN );
#define __S2_Metrics_$LATITUDE_STRING_MAX_LEN 11
CREATE_STRING_STRUCT( S2_Metrics, __$LATITUDE, __S2_Metrics_$LATITUDE_STRING_MAX_LEN );
#define __S2_Metrics_$LONGITUDE_STRING_MAX_LEN 11
CREATE_STRING_STRUCT( S2_Metrics, __$LONGITUDE, __S2_Metrics_$LONGITUDE_STRING_MAX_LEN );
...
START_GLOBAL_VAR_STRUCT( S2_Metrics )
{
   ...
   DECLARE_STRING_STRUCT( S2_Metrics, __$MAC );
   DECLARE_STRING_STRUCT( S2_Metrics, __$BUILDING );
   DECLARE_STRING_STRUCT( S2_Metrics, __$ROOM );
   DECLARE_STRING_STRUCT( S2_Metrics, __$FLOOR );
   DECLARE_STRING_STRUCT( S2_Metrics, __$LATITUDE );
   DECLARE_STRING_STRUCT( S2_Metrics, __$LONGITUDE );
   ...
   DECLARE_STRING_STRUCT( S2_Metrics, __DMPSMAC );
   DECLARE_STRING_STRUCT( S2_Metrics, __CLIENTBUFFER );
   DECLARE_SOCKET( S2_Metrics, __CLIENT );
   DECLARE_SOCKET( S2_Metrics, __LOCALCONSOLE );
   DECLARE_SOCKET( S2_Metrics, __TOUCHPANELCONSOLE );
};
